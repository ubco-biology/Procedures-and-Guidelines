...
To see an example root directory readme file click [here](files/rootREADME.md). 
...
To see an example data directory readme file click [here](files/dataREADME.md).
...
To see an example data dictionary click [here](files/DATA-DICTIONARY.md). 
