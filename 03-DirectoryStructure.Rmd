...
To see an example root directory readme file click [here](files/_rootREADME.md). 
...
To see an example data directory readme file click [here](files/_dataREADME.md).
...
To see an example data dictionary click [here](files/_DATA-DICTIONARY.md). 
...
[_README.md](files/biol-125-readme_V0.md)
...
<img src="images/directory-example-1.png" alt="" />
...
[_README.md](files/biol-125-data-readme_V0.md)

Next, let's create a data dictionary for our new dataset. It should look something like this:

[_DATA-DICTIONARY.md](files/biol-125-data-dictionary_V0.md)

Now our project directory looks like this:

<img src="images/directory-example-2.png" alt="" />
...
[_README.md](files/biol-125-data-readme_V1.md)
...
[_README.md](files/biol-125-readme_V1.md)
...
[_DATA-DICTIONARY.md](files/biol-125-data-dictionary-distance_V0.md)
...
<img src="images/directory-example-3.png" alt="" />
...
<img src="images/directory-example-4.png" alt="" />
...
<img src="images/directory-example-5.png" alt="" />
