...
\textbf{NOTE} This is a living document. Expect that content will be added over time and adapted as needs and circumstances change.
...
Dates should be written in the following format: \textbf{yyyymmdd}. They should contain no spaces, no dashes, no words, just 8 numbers. Months and Days that are from 1 - 9 should be led by a 0. For example, January 23, 2020, should be written \textbf{20200123}. When written this way, your computer will always sort your files from the earliest date to the latest date.
...
In fact, when we think about best practices in science leveraging tools that allow for reproducibility and interpretability (they are independent of specific operating systems or programs for example), Markdown is an essential authoring tool.
...
Learn more about academic integrity from the \href{https://learningcommons.ubc.ca/resource-guides/understand-academic-integrity/}{UBC Learning Commons}.
...
Learn more about copyright at UBC from the \href{https://learningcommons.ubc.ca/resource-guides/respect-copyright/}{UBC Learning Commons}.
